...
export function SettingsDialog() {
  ...
  return (
    <Dialog open={settingsOpen} onOpenChange={setSettingsOpen}>
      ...
      <DialogContent className="flex h-[60vh] max-h-[85vh] w-full max-w-[calc(100%-2rem)] flex-col gap-0 overflow-hidden p-0 sm:max-w-3xl ring-0">
        ...
        <div className="flex min-h-0 flex-1">
          {/* 左侧菜单 */}
          <nav className="w-44 shrink-0 space-y-1 overflow-y-auto p-3">
