    ...
    <div className={cn("text-[15px] leading-relaxed break-words", className)}>
      <ReactMarkdown
        ...
        components={{
          ...
          h1: ({ children }) => <h1 className="mb-2 text-[17px] font-semibold">{children}</h1>,
          h2: ({ children }) => <h2 className="mb-2 text-base font-semibold">{children}</h2>,
          h3: ({ children }) => <h3 className="mb-1 text-[15px] font-medium">{children}</h3>,
          blockquote: ({ children }) => (
          ...
          pre: ({ children }) => (
            <pre
              className="mb-2 overflow-x-auto rounded-md border border-border p-3 text-[13px] leading-relaxed"
