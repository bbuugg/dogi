...
import { cn } from 'cn'
import { AiConfigSettings } from '@/features/settings/AiConfigSettings'
import { TerminalSettings } from '@/features/settings/TerminalSettings'
import { PrefSettings } from '@/features/settings/PrefSettings'
  ...
  return (
    ...
    >
      <div className="flex h-full min-h-0">
        {/* 左侧菜单 */}
        <nav className="no-scrollbar w-44 shrink-0 space-y-1 overflow-y-auto">
        ...
        {/* 右侧内容 */}
        <div className="no-scrollbar min-w-0 flex-1 overflow-y-auto px-4">
