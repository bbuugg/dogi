...
function ScriptRow({
  ...
  return (
    <div
      ref={ref}
      className={cn(
        'group/scri row-own-bg relative flex min-w-0 flex-1 cursor-pointer items-center gap-2 rounded-md px-1 py-1 transition-colors',
        isDragging && 'opacity-40',
        // 高亮画在最外层整行：右侧悬浮运行/删除按钮所在区域也要有底色，否则视觉上断一块。
