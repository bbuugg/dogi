...
fn main() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::app::plugins_list,
            commands::app::plugins_set_enabled,
            commands::app::plugins_uninstall,
            commands::app::plugins_install,
            commands::app::plugins_reload,
            commands::app::plugin_renderer_code,
            commands::app::plugin_webview_info,
            commands::app::plugin_storage_get,
            commands::app::plugin_storage_set,
            // 窗口
